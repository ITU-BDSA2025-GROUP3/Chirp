...
public class SQLite : IClassFixture<TestDatabaseFixture>, IAsyncLifetime
{
    ...
    public async Task saveCheepsInMemoryDatabase()
    {
        ...
        var a1 = new Author() { AuthorId = 1, Name = "Roger Histand", Email = "Roger+Histand@hotmail.com", Cheeps = new List<Cheep>(), Follows = new  List<Author>() };
        var a2 = new Author() { AuthorId = 2, Name = "Luanna Muro", Email = "Luanna-Muro@ku.dk", Cheeps = new List<Cheep>(), Follows = new  List<Author>() };
